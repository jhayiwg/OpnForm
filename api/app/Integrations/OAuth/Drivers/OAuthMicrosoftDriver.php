...
class OAuthMicrosoftDriver implements OAuthDriver
{
    ...
    {
        $this->provider = Socialite::driver('microsoft');
    }
    ...
    public function getRedirectUrl(): string
    {
        return $this->provider
            ->scopes($this->scopes ?? [])
            ->stateless()
            ->redirectUrl($this->redirectUrl ?? config('services.microsoft.redirect'))
            ->redirect()
            ->getTargetUrl();
    }
